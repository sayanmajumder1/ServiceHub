        ...
        <div class="o35">
                    ...
                    ?>
                      <tr>
                        ...
                        <td data-label="Action"><a href="service_edit.php?id=<?php echo $row['service_id']?>"><button type="button" class="btn btn-outline-info">Edit</button></a></td>
                        <td data-label="Action"><a href="service_delete.php?id=<?php echo $row['service_id']?>"><button type="button" class="btn btn-outline-danger">Delete</button></a></td>
                        </tr>
                    <?php
                        }
                    ?>
