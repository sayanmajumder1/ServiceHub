...
<head>
    ...
    <title>Payment view Profile</title>
...
$res = mysqli_query($con, "SELECT booking.*, users.*, service_providers.provider_name, service.service_name,subservice.subservice_name
    ...
    <button class="btn btn-primary d-lg-none mb-3" id="sidebarToggle">
        ...
        <div class="container-fluid d-flex justify-content-center align-items-center" style="min-height: 100vh;">
            <div class="card profile-card p-4 text-center w-100" style="max-width: 600px;">
                ...
                <div class="card-body">
                    <h4 class="card-title"><?php echo ucfirst($row['name']); ?></h4>
                    ...
                    <div class="text-start px-2 px-md-4">
                        ...
                        <p><strong>Payment Status:</strong> <?php echo ucfirst($row['payment_status']); ?></p>
                    </div>
                </div>
            </div>
        </div>
