...
$res = mysqli_query($con, "select * from users where user_id='".$_GET['id']."'");
...
<div class="d-flex">
    ...
    <button class="btn btn-primary d-lg-none mb-3" id="sidebarToggle">
        ...
        <div class="container-fluid d-flex justify-content-center align-items-center" style="min-height: 100vh;">
            ...
            <img src="\ServiceHub\Homepage\assets\images\<?php echo $row['image']?>" alt="Profile Picture" class="profile-img mx-auto mt-3">
                <div class="card-body">
