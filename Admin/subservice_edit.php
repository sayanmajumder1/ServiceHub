        ...
        <button class="btn btn-primary d-lg-none mb-3" id="sidebarToggle">
                <i class="bi bi-list"></i> Menu
                 ...
                 <?php
                        ...
                        subservice.service_id=service.service_id where subservice_id='".$_GET['id']."'");
            ...
            <div class="o35">
                <div class="col-md-8">
                    <div class="card-body ab2">
                        <h2>Edit Sub Services:</h2>
                        <p class="card-text"> 
                            <form method="POST" action="subservice_update.php" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label>Service Name:</label><br>
                                    <input type="text" name="s_id" id="s_id" value="<?php echo $row['subservice_id']?>" class="con1" hidden>
                                    <input type="text" name="service_id" id="service_id" value="<?php echo $row['service_id']?>" class="con1" hidden>
                                    <input type="text" name="s_name" id="s_name" value="<?php echo $row['service_name']?>"class="con1" required>
                                </div>
                                <div class="mb-3">
                                    <label>Sub Service Name:</label><br>
                                    <input type="text" name="sub_name" id="sub_name" value="<?php echo $row['subservice_name']?>"class="con1" required>
                                </div>
                               <div class="mb-3">
